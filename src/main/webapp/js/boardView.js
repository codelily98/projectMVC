$(function(){
    ...
    $(document).on("click", '#listBtn', function(){
        let pg = $("#pg").val(); // hidden input에서 pg 값 가져오기
                    ...
                    <div id="updateform">
                        <table>
                            <tr>
                                ...
                                <td colspan="3" class="content1"><input type="text" name="resubject" value="${subject}"></td>
                            ...
                            <tr>
                                ...
                                <td colspan="5" class="content3"><textarea name="content">${content}</textarea></td>
                            </tr>
                            <tr>
